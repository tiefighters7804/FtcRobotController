    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData(verticalLeft_encoder position, verticalLeft.getCurrentPosition());
            telemetry.addData(verticalRight encoder position, verticalRight.getCurrentPosition());
